			...
			<div class="container">	
				<div class="col-sm-2">
					<ul class="nav nav-pills nav-stacked">
					  	...
					  	<li class="active"><a href="/khach_hang_tuy_bien.php">Khách hàng</a></li>
							...
							echo "<div class='table-responsive'>";
								echo "<table class='table table-bordered'>";
									...
									while($row = mysql_fetch_row($result))
									{
										...
										$gioi_tinh = $row[2];
										if($gioi_tinh==1)
											$hinh = "<img src='img/images/female.png' alt='' width='50' height='50' />";
										else
											$hinh = "<img src='img/images/male.png' alt='' width='50' height='50' />";
										$dia_chi = $row[3];
										$dien_thoai = $row[4];
										...
										echo "<tr>";	
											...
											echo "<td class='text-center'>$hinh</td>";
											echo "<td>$dia_chi</td>";
